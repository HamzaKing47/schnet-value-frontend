...
const OnlineSoftware = () => (
  <section className="py-24 bg-gradient-to-b from-white to-primaryLight/20">
    <div className="max-w-[1200px] mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {items.map((item, i) => (
          <div key={i} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition-all duration-200 group">
            <div className="flex items-start gap-4">
              ...
              <span className="font-medium text-textDark">{item}</span>
            </div>
          </div>
        ))}
      </div>
