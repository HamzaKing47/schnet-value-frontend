...
const Hero = ({ onDemoRequest = () => alert("Demo button clicked!") }) => (
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <button
              ...
              className="bg-white text-primary border-2 border-primary px-6 sm:px-8 py-3 sm:py-3.5 rounded-md font-bold hover:bg-primaryLighter transition-all duration-200 text-center text-sm sm:text-base"
            >
              Demo anfragen
            </button>
          </div>
